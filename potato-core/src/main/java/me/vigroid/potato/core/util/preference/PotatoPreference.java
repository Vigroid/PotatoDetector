package me.vigroid.potato.core.util.preference;
...
public class PotatoPreference {
    ...
    private static final SharedPreferences PREFERENCES =
            PreferenceManager.getDefaultSharedPreferences(Potato.getApplicationContext());
    ...
    public static void addCustomInt(String key, int val) {
        getAppPreference()
                .edit()
                .putInt(key, val)
                .apply();
